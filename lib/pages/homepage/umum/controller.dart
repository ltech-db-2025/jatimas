...
BarangUmumController getBarangUmumController() {
  if (Get.isRegistered<BarangUmumController>()) {
    return Get.find<BarangUmumController>();
  } else {
    return Get.put(BarangUmumController());
  }
}

class BarangUmumController extends GetxController {
  BarangUmumController();
