...
class StockWidget extends StatelessWidget {
            ...
            child: ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: darkGrey.withValues(alpha: 0.1),
                  ),
                  child: Column(
                    children: [
                      Text(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    width: 1.0,
                    color: darkGrey.withValues(alpha: 0.35),
                  ),
                ),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
  ...
  Padding accountsWidget(BuildContext context, String title, String value, {bool isPercentage = false}) {
    return Padding(
