...
class BarangPage extends StatefulWidget {
  ...
  @override
  State<BarangPage> createState() => _PriceListPageState();
}

class _PriceListPageState extends State<BarangPage> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            padding: EdgeInsets.zero,
            icon: Icon(Icons.add_circle_outline, color: background),
            onPressed: null, //() => Get.to(() => BarangEditorPage(Barang())),
          ),
          // const IconButton(visualDensity: VisualDensity(horizontal: -4.0, vertical: -4.0), padding: EdgeInsets.zero, icon: Icon(CupertinoIcons.sort_down, color: background), onPressed: null //() => c.shuwUrut(context),
          //     ),
...
/*               placeholder: (context, url) =>
      ...
      title: Row(
        children: [
          Expanded(
            child: InkWell(
              onTap: () => Get.toNamed('/barang/detail', arguments: item),
              child: Column(
                ...
                children: [
                  ...
                  if ((item.nostok ?? 0) != 1)
                    RichText(
                      ...
                      children: [
                        const TextSpan(text: "Stok  ", style: TextStyle(fontSize: 11)),
                        TextSpan(
