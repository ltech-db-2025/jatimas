...
class DetailBarangPage extends StatefulWidget {
  final BARANG data;
  const DetailBarangPage(this.data, {super.key});
...
class _DetailBarangPageState extends State<DetailBarangPage> {
  ...
  void initState() {
    data = widget.data;
    c = Get.put(BarangDetailController(context: context, data: data));
  ...
  Widget _bottomButton(BarangDetailController c) {
    return BottomNavigationBar(
      ...
      items: const <BottomNavigationBarItem>[
        BottomNavigationBarItem(backgroundColor: mainColor, icon: Icon(Icons.list, color: Colors.grey), activeIcon: Icon(Icons.list, color: mainColor), label: "Detail"),
        BottomNavigationBarItem(backgroundColor: mainColor, icon: Icon(Icons.collections, color: Colors.grey), activeIcon: Icon(Icons.collections, color: mainColor), label: "Gambar"),
        BottomNavigationBarItem(backgroundColor: mainColor, icon: Icon(Icons.iso, color: Colors.grey), activeIcon: Icon(Icons.iso, color: mainColor), label: "Mutasi"),
