          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  data.name,
                  style: const TextStyle(fontWeight: FontWeight.w600, fontFamily: 'poppins', color: AppColor.secondary),
                ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: const TextStyle(fontWeight: FontWeight.w700, fontFamily: 'poppins', color: AppColor.primary),
                        ),
                      ),
