        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              labelStyle: const TextStyle(fontWeight: FontWeight.w500, fontFamily: 'poppins', fontSize: 12),
              unselectedLabelStyle: const TextStyle(fontWeight: FontWeight.w400, fontFamily: 'poppins', fontSize: 12),
              tabs: const [
                Tab(
                  text: 'Related',
                ),
