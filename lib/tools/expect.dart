...
// ignore_for_file: parameter_assignments, type_annotate_public_apis, cast_nullable_to_non_nullable, depend_on_referenced_packages
...
typedef ErrorFormatter = String Function(dynamic actual, Matcher matcher, String? reason, Map matchState, bool verbose);
...
Future expectLater(actual, matcher, {String? reason, skip}) => _expect(actual, matcher, reason: reason, skip: skip) as Future;
...
FutureOr _expect(
  ...
  formatter ??= (actual, matcher, reason, matchState, verbose) {
    ...
    return _formatFailure(matcher, actual, mismatchDescription.toString(), reason: reason);
  };
